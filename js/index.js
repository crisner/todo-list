...
let view = {
     ...
     * @memberof view
     * @param {Object} todos - Placeholder for array item
     */
    ...
    setEventHandlers: function() {
        ...
        /**
         * Add event listener
         * @description Adds event listener for click
         * @listens click
         * @fires function
         * @param e event
         * @memberof view
        ...
        todoUl.addEventListener("click", function(e) {
            ...
            if (elementClicked.className === "delete") {
                 ...
                 * @event view.deleteTodoAnimation
                 */
            ...
            if (elementClicked.className === "toggle") {
                /**
                 * toggle todo item
                 * @event handlers.toggleCompleted(index)
                 */
                let index = elementClicked.parentNode.id;
        ...
        /**
         * Add event listener
         * @description Adds event listener for double click
         * @listens dblclick
         * @fires function
         * @param e event
         * @memberof view
        ...
        /**
         * Add event listener
         * @description Adds event listener for keypress
         * @listens keypress
         * @fires function
         * @param e event
         * @memberof view
